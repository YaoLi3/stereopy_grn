...
logger = LogManager(log_path='./SS200000108BR_A3A4.raw.log',level='debug').get_logger(name='Stereo')
...
if __name__ == '__main__':
    ...
    SC_EXP_FNAME = os.path.join(RESOURCES_FOLDER, 'StereopyData/SS200000108BR_A3A4.raw.gef')#SS200000135TL_D1.cellbin.gef')#SS200000154TR_F5.cellbin.gef')
    ...
    ex_matrix, genes = load_data(SC_EXP_FNAME, bin_type='bins')
    ...
    # 3. GRN inference
    adjacencies = grn_inference(ex_matrix, tf_names, genes, num_workers=24) 
